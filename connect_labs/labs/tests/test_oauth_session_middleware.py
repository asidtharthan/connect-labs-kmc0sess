...
from connect_labs.labs.oauth_session import LabsOAuthSessionMiddleware
...
@patch("connect_labs.labs.connect_tokens.httpx.post")
...
@pytest.mark.django_db
@override_settings(CONNECT_OAUTH_CLIENT_ID="test")
@patch("connect_labs.labs.connect_tokens._exchange_refresh_token")
